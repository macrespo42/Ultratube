...
export default function FormAuthenticate({
  ...
  return (
    <div className="bg-tertiary m-auto p-6 md:p-8 mt-20 w-10/12 h-3/6 md:w-6/12 lg:w-96 lg:h-4/6 rounded">
      <h1 className="mb-10 text-heading-lg text-quinary text-light font-custom">
        {" "}
        {t(nameForm)}
      </h1>
      ...
      <div className="flex gap-3 my-6 justify-evenly">
        <Link
          className={`w-full flex flex-row gap-1 justify-center items-center text-quinary bg-gray-300 rounded text-body-md font-custom hover:bg-white px-2.5 py-2.8"`}
        ...
        <Link
          className={`w-full flex flex-row gap-1 justify-center items-center text-quinary bg-gray-300 rounded text-body-md font-custom hover:bg-discord px-2.5 py-2.8"`}
        ...
        <Link
          className={`w-full flex flex-row gap-1 justify-center items-center text-quinary bg-gray-300 rounded text-body-md font-custom hover:bg-github px-2.5 py-2.8`}
      ...
      <div className="flex w-full gap-3 justify-center mt-4">
        ...
        <Link
          to={linkOtherAUth}
          className="text-secondary text-body-md hover:text-secondaryDark"
        >
